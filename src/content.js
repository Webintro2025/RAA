const content = [
  // ABS Category
  {
    ...
    description: ' Premium virgin ABS (Acrylonitrile Butadiene Styrene) granules offer exceptional mechanical properties, including high impact resistance, dimensional stability, and excellent surface finish. These first-grade materials are perfect for automotive components, electronic housings, appliance parts, and consumer goods. With superior chemical resistance and temperature tolerance, VriginABS granules ensure consistent processing performance and reliable end-product quality for demanding industrial applications across multiple manufacturing sectors.'
  },
  {
    ...
    description: ' Eco-friendly reprocessed ABS granules provide an economical solution without compromising quality. Available in a vibrant spectrum of colors including natural, blue, green, red, yellow, and custom shades, these recycled materials maintain excellent mechanical properties and processing characteristics. Ideal for non-critical applications such as toys, housewares, garden products, and decorative items.'
  },
  ...
  },
  {
    ...
    description: ' Cost-effective reprocessed GPPS granules offer excellent value while maintaining good mechanical and optical properties. Available in an extensive color palette including black, ivory, pink, amber, red, orange pearl, maroon, and golden shades, these materials are perfect for decorative items, promotional products, and non-critical packaging applications. Despite being recycled,  reprocessed GPPS maintains reliable processing characteristics and dimensional stability, making them suitable for injection molding and extrusion processes while supporting environmental sustainability initiatives.'
  },
  {
    id: 'virgin-hips',
    name: 'Virgin HIPS',
    ...
    description: 'VriginHIPS (High Impact Polystyrene) granules combine the processability of general-purpose polystyrene with enhanced impact resistance and toughness. These premium materials are engineered for applications requiring durability and strength, including refrigerator linings, television housings, computer monitors, and automotive interior components. With excellent dimensional stability, good chemical resistance, and superior impact properties, VriginHIPS ensures reliable performance in demanding applications while maintaining ease of processing and cost-effectiveness for high-volume production runs.'
  },
  {
    id: 'reprocess-hips',
    name: 'Reprocess HIPS',
    ...
    description: ' Reprocessed HIPS granules provide an economical alternative while retaining good impact strength and processing characteristics. These recycled materials are suitable for less critical applications such as disposable containers, protective packaging, toys, and household items. With maintained dimensional stability and acceptable mechanical properties,  reprocessed HIPS offers cost savings without significant performance compromise. The material processes well in injection molding and thermoforming applications, making it an excellent choice for manufacturers seeking sustainable and budget-friendly solutions for non-demanding applications.'
  },
  ...
  // PP Category
  {
    ...
    description: ' Premium virgin polypropylene granules offer exceptional chemical resistance, low density, and excellent mechanical properties. These high-grade materials are perfect for automotive parts, food packaging, medical devices, and consumer appliances. With outstanding fatigue resistance, good dimensional stability, and superior processing characteristics, VriginPP ensures consistent injection molding performance. The material exhibits excellent resistance to stress cracking, chemicals, and environmental conditions, making it ideal for demanding applications requiring long-term durability and reliability in various industrial and commercial sectors.'
  },
  {
    id: 'reprocess-pp',
    name: 'Reprocess PP',
    ...
    description: ' Reprocessed polypropylene granules provide cost-effective solutions while maintaining good chemical resistance and mechanical properties. These recycled materials are suitable for non-critical applications such as storage containers, garden furniture, automotive non-structural components, and general-purpose molded parts. With retained flexibility, good impact resistance, and reliable processing characteristics,  reprocessed PP offers significant cost savings. The material maintains acceptable dimensional stability and chemical resistance, making it an environmentally responsible choice for manufacturers seeking sustainable alternatives without compromising basic performance requirements for everyday applications.'
  },
  ...
  },
  {
    ...
    category: 'SAN',
    images: [
      '/Smoke SAN Granules.png',
      '/Natural Blue SAN Granules.png',
      '/Blue SAN Granules.png',
      '/Natural SAN Granules.png'
    ],
    description: ' Reprocessed SAN granules maintain excellent optical properties while offering cost-effective solutions for semi-transparent applications. These recycled materials retain good clarity, chemical resistance, and processing characteristics suitable for non-critical transparent products such as storage containers, display cases, and decorative items. With maintained dimensional stability and acceptable stress crack resistance,  reprocessed SAN provides significant cost savings while supporting sustainable manufacturing practices. The material offers reliable injection molding performance and maintains sufficient transparency for applications where perfect optical clarity is not essential.'
  },
  {
    id: 'san-regrind',
    name: 'SAN Regrind',
  ...
  },
  {
    ...
    description: ' Reprocessed polycarbonate granules maintain excellent mechanical properties while providing cost-effective solutions for less critical applications. These recycled materials retain good impact resistance, dimensional stability, and processing characteristics suitable for automotive interior components, electronic enclosures, and industrial parts. With maintained toughness and acceptable optical properties,  reprocessed PC offers significant cost savings without major performance compromise. The material provides reliable injection molding performance and maintains sufficient engineering properties for applications where virgin-grade performance is not essential, supporting sustainable manufacturing practices.'
  },
  {
    ...
    description: ' Polycarbonate regrind material offers an environmentally sustainable solution while maintaining basic engineering properties. Available in natural, smoky, and red colors, this ground material is suitable for non-critical applications, filler material, and blend applications. With acceptable impact resistance and processing characteristics,  PC regrind can be used independently or blended with virgin materials to reduce costs. The material supports circular economy initiatives by recycling post-industrial waste while providing adequate performance for applications where appearance and maximum properties are not primary requirements, enabling sustainable manufacturing practices.'
  },
