        ...
        <div className="flex flex-col space-y-6 lg:grid lg:grid-cols-4 lg:gap-8 lg:space-y-0">
          ...
          <div className="grid grid-cols-2 gap-4 lg:contents">
            ...
            <div>
              ...
              <ul className="text-white text-[11px] sm:text-xs lg:text-sm space-y-1 lg:space-y-1.5">
                ...
                <li><Link href="/products/reprocess-gpps-granules" className="hover:text-[#48A1C7] cursor-pointer transition-colors">REPROCESS GPPS GRANULES</Link></li>
                <li><Link href="/products/virgin-gpps-granules" className="hover:text-[#48A1C7] cursor-pointer transition-colors">VIRGIN GPPS GRANULES</Link></li>
                <li><Link href="/products/pet-granules" className="hover:text-[#48A1C7] cursor-pointer transition-colors">PET GRANULES</Link></li>
                <li><Link href="/products/wankai-pet-resin" className="hover:text-[#48A1C7] cursor-pointer transition-colors">WANKAI PET RESIN</Link></li>
                ...
                <li><Link href="/products/virgin-pp-granules" className="hover:text-[#48A1C7] cursor-pointer transition-colors">VIRGIN PP GRANULES</Link></li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 lg:block">
            ...
            <div>
              ...
              <div className=' w-16 lg:w-20 h-0.5 bg-[#FFD600] mb-3.5'></div>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-[#3F6165] rounded-full flex items-center justify-center">
              ...
              <div className="hidden lg:block mt-6 lg:mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {/* Facebook */}
                  <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" className="w-6 h-6 lg:w-8 lg:h-8 bg-[#3F6165] rounded-full flex items-center justify-center hover:bg-[#FFD600] transition-colors" aria-label="Facebook">
                  ...
                  {/* Instagram */}
                  <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="w-6 h-6 lg:w-8 lg:h-8 bg-[#3F6165] rounded-full flex items-center justify-center hover:bg-[#FFD600] transition-colors" aria-label="Instagram">
                    <svg className="w-3 h-3 lg:w-4 lg:h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="lg:hidden">
              ...
              <div className=' w-16 h-0.5 bg-[#FFD600] mb-3.5'></div>
              <div className="flex flex-wrap gap-2">
                <a href="#" className="w-6 h-6 bg-[#3F6165] rounded-full flex items-center justify-center hover:bg-[#FFD600] transition-colors">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                  </svg>
                </a>
                <a href="#" className="w-6 h-6 bg-[#449833] rounded-full flex items-center justify-center hover:bg-[#48A1C7] transition-colors">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
